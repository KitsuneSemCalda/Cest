...
// ============================================================================
// Hooks (beforeEach/afterEach) - disabled with CEST_NO_HOOKS
// ============================================================================
...
// Enhanced Matchers
// ============================================================================
static inline int match_regex(cest_value_t a, cest_value_t b) {
#ifdef __cplusplus
...
static inline int match_not(cest_value_t a, cest_value_t b) {
    return !match_eq(a, b);
}
